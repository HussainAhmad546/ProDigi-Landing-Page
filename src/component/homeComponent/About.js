...
const About = () => {
  ...
  const arr = [
    ...
    },
    {
      ...
      title: "Clients",
      range: "300+",
      paragraph: "With over hundreds of satisfied clients globally, Prodigia has established a strong reputation.",
    },
    {
      pic: pic3,
      title: "Success",
      range: "98%",
      paragraph: "With a success rate of 98%, Prodigia ensures high-quality deliverables and client satisfaction.",
    },
    {
      pic: pic4,
      title: "Years",
      range: "8+",
      paragraph: "With over 8 years of dedicated service, Prodigia has gained invaluable experience and expertise.",
    },
  ];
